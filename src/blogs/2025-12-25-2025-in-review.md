...
description: "A reflective journey through the first chapter of 2025 (January–April): from experimental coding and hackathon wins to finding a new direction in software development. A look back at the lessons learned and the foundations built for the future."
...
Not long after stepping away from freelancing, I joined the <a class="link" href="https://www.codementor.io/projects/" target="_blank" rel="noopener noreferrer">**Codementor DevProjects Challenge**</a>, themed <a class="link" href="https://www.codementor.io/projects/web/create-a-fast-and-secure-blog-using-jamstack-c93coupnxb" target="_blank" rel="noopener noreferrer"> _“Create a fast and secure blog using JAMstack.”_</a>
...
1.  **Fintech Hackathon:** We built a peer-to-peer money transfer system using NFC. We didn’t just pitch an idea; we had a working prototype. We won **first place** and a **$1,000 cash prize**.

<div align="center" style="margin: 20px 0;">
  <video controls class="video-portrait" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
    <source src="/assets/videos/fintech-demo.MOV" type="video/mp4">
    Your browser does not support the video tag.
  </video>
  <p><em>Showcasing the NFC-based Peer-to-Peer transfer prototype in action.</em></p>
</div>

2.  **Agritech Hackathon:** We took a different approach—no MVP, just a deeply thought-out idea grounded in real agricultural challenges. We placed **third**, and that idea became what is now known as **AgriLease**.
